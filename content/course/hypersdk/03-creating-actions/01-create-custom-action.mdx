...
Place the following code in `actions/greeting.go`. The code includes some comments, but for more details, check out the [docs folder in HyperSDK](https://github.com/Dijets-Inc/hypersdk/tree/main/docs).
...
import (
	...
	"github.com/Dijets-Inc/dijetsnodesgo/ids"

	"github.com/Dijets-Inc/hypersdk-starter/consts"
	"github.com/Dijets-Inc/hypersdk-starter/storage"
	"github.com/Dijets-Inc/hypersdk/chain"
	"github.com/Dijets-Inc/hypersdk/codec"
	"github.com/Dijets-Inc/hypersdk/state"
	"github.com/Dijets-Inc/hypersdk/utils"
)
