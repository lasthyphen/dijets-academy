...
description: Learn about Intain's permissioned Dijets ECC.
updated: 2024-06-28
authors: [usmaneth]
icon: Microscope
---

Intain operates a structured finance platform. It has **IntainMARKETS**, a marketplace for tokenized asset-backed securities built as Dijets ECC.
...
The **IntainMARKETS L1** also uses other ways to adhere to regulatory requirements. It has U.S-hosted infrastructure, which allows data to reside domestically, while validators chosen by network participants must also be verified U.S. entities and individuals. The Dijets ECC economics are not dependent on any public token, and transaction costs are independent from those of the Dijets Utility Chain and other Dijets ECCs.