...
description: Understand the components of the DITTO structure
updated: 2024-05-31
authors: [ashucoder9]
icon: BookOpen
---
...
The ERC20 and native token transferrers built on top of InterECC Messaging are composed of interfaces and abstract contracts that make them extendable to new implementations in the future.
