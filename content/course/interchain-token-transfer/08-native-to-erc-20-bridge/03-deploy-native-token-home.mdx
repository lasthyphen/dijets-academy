...
description: Deploy the NativeTokenHome contract on the Dijets ECC blockchain.
updated: 2024-05-31
...
<Callout>You may already have `TELEPORTER_REGISTRY_ECC` and `SOURCE_BLOCKCHAIN_ID_HEX` set from previous sections. If you do, you can skip to step 5.</Callout>
<Steps>
<Step>
...
|               +------------------------------+--------------------------------------------+
|               | Jumper Registry Address  | 0xB4DC3d786D658d118631F5C6B75CB5935be8407C | // [!code highlight]
+---------------+------------------------------+--------------------------------------------+
```
</Step>
<Step>
...
Using the [`forge create`](https://book.getfoundry.sh/reference/forge/forge-create) command, we will deploy the [NativeTokenHome.sol](https://github.com/Dijets-Inc/dijets-interchain-token-transfer/blob/main/contracts/src/TokenHome/NativeTokenHome.sol) contract, passing in the following constructor arguments:
