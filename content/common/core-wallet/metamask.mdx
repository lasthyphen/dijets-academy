If you've added both Metamask and Decypher Wallet to your browser, you could face some problems. But to fix them, you don't need to remove Metamask. Just follow the below steps to disable the Metamask extension:
