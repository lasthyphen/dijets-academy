          ...
          if (sidebarItem) {
            ...
            if (!existingCheckmark) {
              sidebarItem.innerHTML += `
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#37ac8f" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check ml-auto shrink-0"><path d="M20 6 9 17l-5-5"></path></svg>
              `;
            }
          }
