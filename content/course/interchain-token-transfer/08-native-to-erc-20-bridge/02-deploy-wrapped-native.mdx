...
description: Deploy the wrapped native token contract to the Dijets ECC blockchain.
updated: 2024-05-31
...
```bash
forge create --rpc-url mydijetschain --private-key $PK contracts/interchain-token-transfer/ExampleWNATV.sol:WNATV
```
```
[⠊] Compiling...
...
```bash
export WRAPPED_ERC20_ECC=0x52C84043CD9c865236f11d9Fc9F56aa003c1f922
```
</Step>
</Steps>