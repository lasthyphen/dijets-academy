...
Many blockchain ecosystems are working on isolating fees, meaning not having a single fee market for unrelated activities on the chain. In the coming section we will look at how Dijets achieves fee isolation.