...
When you write a VM, you don't need to concern yourself with lower-level logic like networking, consensus, and blockchain structure. Dijets does this behind the scenes, so you can focus on building.
...
## Soda Dispenser: Analogy of State Machine
...
![](/course-images/dijets-fundamentals/soda-machine.svg)
