    ...
    <div className="bg-gray-50 dark:bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-white dark:bg-black shadow-lg rounded-lg overflow-hidden">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Let's test your course knowledge so far. {quizInfo.correctAnswers.length === 1 ? "Select the correct answer." : "Select all correct answers."}
        </p>
      </div>
            ...
            <div 
              ...
              className={`flex items-center p-3 rounded-lg border transition-colors cursor-pointer ${
                isAnswerChecked
                  ...
                  : selectedAnswers.includes(index)
                    ? 'border-[#37ac8f] bg-[#37ac8f] bg-opacity-10 dark:bg-opacity-30'
