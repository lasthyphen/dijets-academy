...
description: Learn about different ways of permissioning your Dijets ECC blockchain.
updated: 2024-06-28
authors: [usmaneth]
icon: Book
---
...
- **Permissionless Validation:** Anyone can participate in the validation process and be rewarded in tokens to cover their costs for the hardware and running the validator. In Dijets, we call Dijets ECCs that take this approach Elastic Dijets ECCs.
- **Permissioned Validation:** Only whitelisted validators can validate the Dijets ECC. A permissioned Dijets ECC can be turned into a Elastic Dijets ECC at any time, but not the other way round.

There are many reasons why the creators might want a permissioned validator set for their Dijets ECC. 
