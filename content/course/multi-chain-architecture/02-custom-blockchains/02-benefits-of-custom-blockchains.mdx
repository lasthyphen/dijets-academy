...
While the Utility Chain operates as an open and permissionless network, custom blockchains provide more granular control over user access and permissions. This feature is particularly valuable for applications that need to meet specific regulatory requirements.
...
While public blockchains offer transparency, many business scenarios require controlled visibility of transaction data. Developers building custom blockchains on Dijets can enable: 
...
The ability to choose or create custom Virtual Machines (VMs) offers unprecedented flexibility. Dijets custom blockchains allow for developers to have: 

- Multiple VM Support: Unlike single-VM networks like Bitcoin or Ethereum, Dijets Dijets ECCs can host multiple blockchain instances with different VMs.
...
- Network Effects: This flexible architecture creates network effects both within individual blockchains and across different Dijets ECCs and blockchains.
...
Custom blockchains, especially within the Dijets ecosystem, can be designed with interoperability in mind and can enable: 

- Cross-Chain Communication: Facilitate seamless interaction between different custom blockchains in the Dijets network leverage Dijets Warp Messaging.
- Asset Bridges: Create efficient bridges for asset transfers between your custom blockchain and other networks such as the Dijets Interchain Token Transfer. 
