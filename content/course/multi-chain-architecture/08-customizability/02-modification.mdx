...
In Dijets, creating modified VMs is straightforward. The subnetEVM for instance can be customized through the development of plugins as well as precompiles.