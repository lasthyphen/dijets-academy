...
When creating Dijets ECC we cannot only configure our custom native token, but also how the transaction fees (also known as gas fees) are determined. This allows Dijets ECCs to define the desired or maximal throughput of the blockchain differently.
