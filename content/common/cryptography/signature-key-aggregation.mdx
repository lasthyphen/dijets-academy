...
Looks good so far, but let's now think about a message signed by a large portion of the Primary Network validators on Dijets Mainnet. That would result in hundreds if not thousands of signatures attached to a small message.
