...
description: Deploy and register the ERC20TokenRemote contract to the Dijets Utility Chain.
updated: 2024-05-31
...
Using the [`forge create`](https://book.getfoundry.sh/reference/forge/forge-create) command, we will deploy the [ERC20TokenRemote.sol](https://github.com/Dijets-Inc/dijets-interchain-token-transfer/blob/main/contracts/src/TokenRemote/ERC20TokenRemote.sol) contract, passing in the following constructor arguments:
