---
title: Install Dijets CLI
description: Dijets CLI is a command line tool for accessing Dijets, specializing in developing and testing subnets.
date: 2024-05-26
authors: [andreea]
topics: [Dijets CLI]
---
...
To call the `dijets` binary from anywhere, you'll need to add it to your system path. If you installed
...
The source code is available in this [GitHub repository](https://github.com/Dijets-Inc/dijets-cli).
