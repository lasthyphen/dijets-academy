...
export default function Page(): React.ReactElement {
    ...
    return (
        <main className="py-12 sm:py-24">
         <Courses title="Crypto" subtitle="101" description="We offer fundamental courses specifically designed for individuals who are new to the Dijets ecosystem, and advanced courses for those who wish to master the art of configuring, modifying, or even creating entirely new Virtual Machines from scratch." courses={COURSES.official} />
        {COURSES.ecosystem.length > 0 && <Courses title="Digital" subtitle="Currencies" description="Check out the courses provided by our ecosystem partners." courses={COURSES.ecosystem} />}
        {COURSES.basics.length > 0 && <Courses title="Crypto" subtitle="Concepts" description="Check out the courses provided by our ecosystem partners." courses={COURSES.basics} />}
        </main>
    );
}
