...
Let's look at an Example: Alice owns 5 DJT

Now Alice issues two transactions at the same time to different validators:

1. Sends 5 DJT to Bob
2. Sends 5 DJT to Dooba
...
Each of the transaction in itself is valid. Alice owns 5 DJT and should be able to send them to whomever she wants. However, she should only be able to send the amount she actually owns.
