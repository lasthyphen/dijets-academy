...
For some use cases, it may be necessary to use a customized VM too. This is the case if an application cannot be built on a regular EVM on the Utility Chain, or if it would result in gas costs too high to be economical for its users or creators.
