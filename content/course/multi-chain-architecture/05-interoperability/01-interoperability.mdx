...
description: Learn about interoperability in the Dijets ecosystem
updated: 2024-08-26
...
By enabling cross-chain asset transfers, interoperability can inject liquidity from established blockchains into a new network. For instance, a new Dijets Layer 1 blockchain can integrate with decentralized finance (DeFi) protocols on other chains, bringing in liquidity and users.
